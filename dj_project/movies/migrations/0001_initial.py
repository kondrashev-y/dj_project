# Generated by Django 3.1.2 on 2020-10-12 21:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('url', models.SlugField(max_length=160, unique=True)),
                ('druft', models.BooleanField(default=False, verbose_name='Черновик')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('movie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.movie', verbose_name='фильм')),
                ('star', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='movies.ringstar', verbose_name='звезда')),
            ],
            options={
